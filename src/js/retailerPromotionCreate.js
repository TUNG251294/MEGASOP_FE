    ...
    isValidToContinue: function () {
      return (
        ...
        (this.form.regions.length > 0 ||
          this.form.cities.length > 0 ||
          this.form.retailers.length > 0) &&
  ...
  methods: {
            ...
            if (self.checkTypeFormat(groups)) {
              ...
              switch (self.form.rewardFormatId) {
                ...
                default:
                  message =
                    this.$t(
                      'promotions.please_enter_the_discount_limit_value'
                    ) +
                    (index + 1) +
                    this.$t('promotions.before_adding_a_new_limit')
                  break
    ...
    changeFixValue: function (index, productIndex, event) {
      ...
      if (index == 0) {
        ...
        min = parseInt(group.fixValue.replace(/,/g, ''))
        max = Number.POSITIVE_INFINITY
      } else {
        grMin = levelGroups[index - 1]
        grMax = levelGroups[index + 1]
    ...
    saveInfo: function () {
      ...
      inputData['retailers'] =
        self.form.designated == 1 ? self.retailerSelection : []
      ...
      // inputData["regions"] =
      //   self.form.designated == 2 ? self.regionSelection : [];
      inputData['regions'] = []
