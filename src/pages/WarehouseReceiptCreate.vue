          ...
          <div class="row breadcrumbs-top">
            <div class="col-12">
              <h3 class="content-header-title float-left pr-2 mb-0">
                {{ $t('stock.create_warehouse_received') }}
              </h3>
              <q-breadcrumbs class="text-brown d-sm-flex d-none pl-2">
                ...
                />
                <q-breadcrumbs-el
                  :label="$t('stock.create_warehouse_received')"
                  style="color: #2a2a2a"
                />
              </q-breadcrumbs>
            </div>
      ...
      <div class="content-body">
          ...
          <div class="d-flex col-md-4 col-sm-12">
            <q-card class="w-100 card card-shadow border-0">
              ...
              <q-card-section>
                ...
                <div class="text-subtitle2">{{ $t('stock.note') }}</div>
                <div class="text-h6 mb-1">
                  <textarea
                    class="form-control"
            ...
            <q-card class="w-100 card card-shadow border-0">
              <q-card-section class="pb-0">
                <div class="d-flex justify-content-between">
                  ...
                  <div class="row">
                    <q-btn
                      class="mr-50 mb-1 mb-lg-0 rounded-50 bg-white"
                    ...
                    />
                    <q-btn
                      class="mb-1 mb-lg-0 rounded-50 bg-white"
        ...
        <div class="row mx-n1 mt-2">
          <div class="col-12 d-flex justify-content-end">
            <q-btn
              class="mb-1 bg-white rounded-50"
        ...
        <q-dialog v-model="persistent" full-width>
...
<script src="../js/warehouseReceiptCreate.js"></script>
