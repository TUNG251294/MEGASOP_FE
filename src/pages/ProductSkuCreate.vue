          ...
          <div class="row breadcrumbs-top">
            <div class="col-12">
              ...
              <q-breadcrumbs class="text-brown d-sm-flex d-none pl-2">
                ...
                <q-breadcrumbs-el
                  :label="$t('sku.create_product')"
                  to="/product-create"
                />
                <q-breadcrumbs-el
                  :label="$t('sku.create_sku')"
                  style="color: #2a2a2a"
                />
              </q-breadcrumbs>
            </div>
              ...
              <div class="row mt-1">
                ...
                <div class="col-sm-6 mt-1 pr-sm-50">
                  ...
                  <q-input
                    ...
                    :rules="[this.isValidSkuName, this.requiredValue, this.validateSkuNameLength]"
                    hide-bottom-space
                    no-error-icon
                  />
                </div>
                ...
                <div class="row mx-n50 mt-1">
                  ...
                  >
                    <div class="form-group">
                      <div class="label-md mb-25">{{ item.name }} <span class="text-danger">*</span></div>
                      <select
                        class="custom-select fs-12"
                        v-model="form.attributes[index]"
                      >
                        <option value="0">
                          {{ $t('sku.select_attribute_value') }}
                        </option>
                        <option
            ...
            <q-card class="w-100 card card-shadow border-0">
              ...
              <q-card-section>
                <div
                  ...
                  :key="image.id"
                >
                  <img class="w-100" :src="image.path" />
                  <q-btn
                    icon="cancel"
                    unelevated
                    round
...
<script src="../js/productSkuCreate.js"></script>
