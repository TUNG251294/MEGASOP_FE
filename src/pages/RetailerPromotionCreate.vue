  ...
  <q-page class="flex">
    ...
    >
          ...
          <div class="row breadcrumbs-top">
            <div class="col-12">
              <h3 class="content-header-title float-left pr-2 mb-0">
                {{ $t('promotions_retailer.create_promotion_for_retailer') }}
              </h3>
      ...
      <div class="content-body">
                  ...
                  <div class="col-12 col-md-4 px-50">
                    <div class="mb-1">
                      ...
                      <q-input
                        ...
                        :placeholder="$t('promotions_retailer.enter_promotion_id')"
                        tabindex="1"
                      />
                    </div>
                  ...
                  <div class="col-12 col-md-8 px-50">
                    <div class="mb-1">
                      ...
                      <q-input
                        ...
                        :placeholder="$t('promotions_retailer.enter_promotion_name')"
                        tabindex="2"
                      />
                    </div>
                  ...
                  >
                    <q-card>
                      <q-scroll-area style="height: 400px; max-width: 700px">
                        <q-list>
                          <q-item class="mb-0" tag="label" v-ripple>
                            <q-item-section>
                              <q-item-label>{{
        ...
        <div class="row mx-n1" v-if="step == 2">
          <div
              ...
              <q-card-section>
                <div class="form-group mt-5" v-if="productGroupsCount == 0">
                  <div class="text-center fs-14 mb-0 w-75 mx-auto">
                    {{ $t('promotions_retailer.add_product_group_to_create_catalog')}}
                  </div>
        ...
        <q-dialog v-model="modalUpdate" position="right" full-height persistent maximized>
          <q-card class="card card-shadow border-0" style="width: 968px">
            ...
            <q-card-section class="q-pt-none">
              <div class="row">
                <div class="col-md-4 col-sm-4 no-pl">
                  <q-tree :nodes="categories" node-key="id" label-key="name">
                    <template v-slot:header-generic="prop">
                      <div class="row items-center">
                        <a
                ...
                <div class="col-md-8 col-sm-8 no-pr">
                  <h6 for="" class="text-weight-bolder mb-1">{{
                    $t('promotions_retailer.select_product')
                  }}</h6>
                  <q-table
...
<script src="../js/retailerPromotionCreate.js"></script>
