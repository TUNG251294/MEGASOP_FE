...
module.exports = configure(function (ctx) {
  return {
    ...
    boot: ['Constants.js', 'i18n', 'axios'],

    // https://v2.quasar.dev/quasar-cli/quasar-conf-js#Property%3A-css
    css: ['app.scss', 'app-extends.scss', 'bootstrap.scss'],
    ...
    build: {
      env: {
        API: 
          ...
          // "http://14.225.194.167:27100"
          // ctx.dev
          // ?
          // 'https://tportalapi.megasop.com'
        // :
        // ? "http://localhost:27100"
        // 'https://portalapi.megasop.com'
      },
